...
export default defineType({
  ...
  fields: [
    ...
    defineField({name: 'strategyReport', title: 'Strategy Report', type: 'object', fields: [
      ...
      defineField({name: 'estimatedCustomers', title: 'Estimated Customers', type: 'string'}),
      defineField({name: 'estimatedRevenuePotential', title: 'Estimated Revenue Potential', type: 'string'}),
      ...
      defineField({name: 'crmAutomationRecommendation', title: 'CRM/Automation Recommendation', type: 'text', rows: 2}),
      defineField({name: 'opportunityScore', title: 'Opportunity Score', type: 'string'}),
